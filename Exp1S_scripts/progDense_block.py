...
class ProgLstmBlock1(ProgBlock):
    def __init__(self, inSize, hidden_size, numLaterals, lat_connect, activation = nn.Tanh(), layerArgs = dict(), skipConn = False, lambdaSkip = identity, dropout=0):
        super().__init__()
        self.numLaterals = numLaterals
        self.inSize = inSize
        self.skipConn = skipConn
...
class ProgLstmBlock2(ProgBlock):
    def __init__(self, inSize, hidden_size, numLaterals, lat_connect, activation = nn.Tanh(), layerArgs = dict(), skipConn = False, lambdaSkip = identity, dropout=0, args=None,):
        super().__init__()
        self.numLaterals = numLaterals
        self.inSize = inSize
        self.skipConn = skipConn
